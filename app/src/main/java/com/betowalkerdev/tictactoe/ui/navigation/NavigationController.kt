package com.betowalkerdev.tictactoe.ui.navigation
...
import com.betowalkerdev.tictactoe.ui.game.GameScreen
import com.betowalkerdev.tictactoe.ui.home.HomeScreen

@Composable
fun NavigationController(navigationController: NavHostController) {
    NavHost(navController = navigationController, startDestination = Routes.Home.route) {
        composable(Routes.Home.route) {
            HomeScreen(navigateToGame = { gameId, userId, owner ->
                navigationController.navigate(Routes.Game.createRoute(gameId, userId, owner))
            })
        }
        composable(
            Routes.Game.route,
